...
public class SimpleUserLeadClientWithMultipleDates
{
    ...
    private static Map<String, String> getDateWisePayoutMap() {
        ...
        payoutMap.put("2025-04-20", "20000");
        payoutMap.put("2025-05-21", "200");
        payoutMap.put("2025-06-22", "300");
        payoutMap.put("2025-07-23", "400");
        payoutMap.put("2025-08-24", "500");
        payoutMap.put("2025-09-25", "600");
        return payoutMap;
    }
